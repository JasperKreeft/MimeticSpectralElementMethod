function varargout = interpolationfunction(form,varargin)
...
F = exact_solution(X,Y,FunctionType,'vorticity');
...
for j = 1:N
    for i = 1:N+1
        ...
        [fx,fy] = exact_solution(xx,yy,FunctionType,'velocity');
...
for i=1:N
    for j=1:N
        ...
        f = exact_solution(xx,yy,FunctionType,'pressure');
