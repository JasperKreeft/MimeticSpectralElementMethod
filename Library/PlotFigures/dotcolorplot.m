function [H,C]=dotcolorplot(phi,x,y,phimin,phimax)
...
H = scatter3(x,y,phi,100*ones(M,1),colormap_phi,'filled');
C = colorbar('yticklabel',roundn(linspace(phimin,phimax,6),-2));