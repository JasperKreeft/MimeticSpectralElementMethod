...
%     plotTwoFormReduced = 0;
    ...
    [phi gSpace g11 g12 g22 dPhiXdXi dPhiYdXi dPhiXdEta dPhiYdEta gU11 gU12 gU22 dPhiXidX dPhiEtadX dPhiXidY dPhiEtadY] = ...
                    DefineMapping(n,mapX_Coeff1,mapX_Coeff2,mapY_Coeff1,mapY_Coeff2,deltaX,deltaY,map,curved,true,true);
...
%     end
    ...
    % 1-forms
    fluxesDiscrete = DiscretizeOneForm(flux, phi, dPhiXdXi, dPhiXdEta, dPhiYdXi, dPhiYdEta, pSpace, gridType);
    ...
    contractionMatrices = ContractionTwoForm2D(n, pSpace, g11, g12, g22, gSpace, dPhiXdXi, dPhiXdEta, dPhiYdXi, dPhiYdEta, gridType, pintSpace, quadrature, gU11, gU12, gU22, dPhiXidX, dPhiEtadX, dPhiXidY, dPhiEtadY);
