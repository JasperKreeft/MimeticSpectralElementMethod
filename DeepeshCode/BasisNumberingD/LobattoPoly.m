...
%evaluated at x.
%
%   result = LobattoPoly(x,p) gives the p+1 Lobatto basis interpolants 
%   evaluated at x.
%   
%   It returns a (n+1)d matrix with the values of the Lobatto basis
...
%
%   If x=[] then it computes the Lobatto polynomial basis at the nodes,
