function [globalError localError nodesX nodesY] = L2ErrorOneForm2D(discreteOneForm,analyticalOneForm,dPhiXdXi,dPhiXdEta,dPhiYdXi,dPhiYdEta,g11,g22,g12,g,phi,xBound,yBound,nReconstruction,gridType,figureNumber)
%L2Error2D Plots a discrete OneForm.
%
%   L2ErrorOneForm2D(discreteOneForm,analyticalOneForm,dPhiXdXi,dPhiXdEta,dPhiYdXi,dPhiYdEta,...
...
%   $Revision: 1.0 $  $Date: 2011/12/12 $
    ...
    % order of method
    p = ceil(sqrt(size(discreteOneForm,1)+0.5)-0.5);
    ...
    [reconstructedX reconstructedY xiRefinedGrid etaRefinedGrid] = ReconstructOneForm2D(discreteOneForm,dPhiXdXi,dPhiXdEta,dPhiYdXi,dPhiYdEta,g,intErrorNodes,gridType);
