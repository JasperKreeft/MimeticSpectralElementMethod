function contractionMatrices = ContractionTwoFormVelocities2D(n, p, g11, g12, g22, g, gridType, varargin)
...
%         evaluatedg = g{element}(quadNodes2DXi(:),quadNodes2DEta(:));
    ...
    for element = 1:nElements
        dim1 = (element-1)*2*nQuadPoints + Dim1;
        % matrix that reconstructs velocities
        velocityMatrix = -[zeros(size(xietaBasisOneEta'))   xietaBasisOneEta'
                           xietaBasisOneXi'                 zeros(size(xietaBasisOneXi'))];
