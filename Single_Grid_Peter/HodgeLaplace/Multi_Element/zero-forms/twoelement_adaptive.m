...
boundary_points = [ 1:Na1 ...
                    ...
                    Na1*(Na1+1)+Na2*(Na2+1)+[1 Na1+1] ];

interior_points = 1:(Na1*(Na1+1)+Na2*(Na2+1)+Na1+1);
...
PPHI = zeros(Na1*(Na1+1)+Na2*(Na2+1)+Na1+1,1);
...
PHI_exact = exact_solution(Mesh.X,Mesh.Y,FunctionType,'zerotwo');   % Nodal exact
