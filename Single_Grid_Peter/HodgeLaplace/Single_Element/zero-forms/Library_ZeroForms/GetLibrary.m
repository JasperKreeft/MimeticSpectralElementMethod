...
switch in
    case 'start'
        ...
        if ispc
            ...
            path(path,'O:\msem\MSEM_codes\Single_Grid_Peter\HodgeLaplace\Single_Element\zero-forms\Library_ZeroForms')
        elseif isunix
            ...
            path(path,'/media/My Passport/MSEM/MSEM_codes/Single_Grid_Peter/HodgeLaplace/Single_Element/zero-forms/Library_ZeroForms')
        end
    ...
    case 'finish'
        ...
        if ispc
            ...
            rmpath('O:\msem\MSEM_codes\Single_Grid_Peter\HodgeLaplace\Single_Element\zero-forms\Library_ZeroForms')
        elseif isunix
            ...
            rmpath('/media/My Passport/MSEM/MSEM_codes/Single_Grid_Peter/HodgeLaplace/Single_Element/zero-forms/Library_ZeroForms')
        end
