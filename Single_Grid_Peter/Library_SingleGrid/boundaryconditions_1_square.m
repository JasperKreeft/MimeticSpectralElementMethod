...
if c==1
    ...
    if bc(1) == 1
        PHIbcL = boundary_oneforms(r,c,FunctionType,Domain,DomInfo,'left','zero');
...
if c==numColumns
    ...
    if bc(2) == 1
        PHIbcR = boundary_oneforms(r,c,FunctionType,Domain,DomInfo,'right','zero');
...
if r==1
    ...
    if bc(3) == 1
        PHIbcB = boundary_oneforms(r,c,FunctionType,Domain,DomInfo,'below','zero');
...
if r==numRows
    ...
    if bc(4) == 1
        PHIbcA = boundary_oneforms(r,c,FunctionType,Domain,DomInfo,'above','zero');
