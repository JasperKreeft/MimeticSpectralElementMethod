...
[Vorticity_bc,TangentialVelocity_bc,boundary_w,interior_w] = boundaryconditions_0_square(Mesh,FunctionType,[1 0 0 1]);

[Pbc,UVbc,boundary_uv,interior_uv] = boundaryconditions_1_square(FunctionType,Domain,DomInfo,[0 1 0 1]);
...
% Matrix = [ 1e-10*speye(nr_1)        M1*NG               D'*M2
%                 NG'*M1              M0          spalloc(nr_0,nr_2,0)
...
WUVP = Matrix\RHS;
% WUVP = minres(Matrix,RHS,1e-6,20000);
