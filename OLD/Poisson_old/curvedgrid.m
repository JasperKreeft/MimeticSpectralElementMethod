...
% S11GLLGLL = dXdXiGLLGLL.*dXdEtaGLLGLL+dYdXiGLLGLL.*dYdEtaGLLGLL;
S11GLLG = dXdXiGLLG.*dXdEtaGLLG+dYdXiGLLG.*dYdEtaGLLG;
S12GLLG = dXdEtaGLLG.^2+dYdEtaGLLG.^2;
S21GGLL = -dXdXiGGLL.^2-dYdXiGGLL.^2;
S22GGLL = -dXdXiGGLL.*dXdEtaGGLL-dYdXiGGLL.*dYdEtaGGLL;
