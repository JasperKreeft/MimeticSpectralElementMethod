...
[TangentialVelocity_bc] = boundaryconditions_0_stokes_triangle();
TangentialVelocity_bc(1) = TangentialVelocity_bc(1)/2;
TangentialVelocity_bc((N+1)^2+N) = TangentialVelocity_bc((N+1)^2+N)/2;

[boundary_uv,interior_uv] = boundaryconditions_1_stokes_triangle();
...
[Meshp,hp,ep] = postproces_grid_triangle();
