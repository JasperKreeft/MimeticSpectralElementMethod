...
%             path(path,[disk ':\MSEM\MSEM_codes\Single_Grid_V5\Stokes\CoVectorValued\Library'])
            ...
            path(path,'C:\Users\Jasper\Documents\MATLAB\MSEM_codes\Single_Grid_V5\Stokes\CoVectorValued\Library')
        ...
        elseif isunix
            ...
            path(path,'/media/My Passport/MSEM/MSEM_codes/Single_Grid_V5/Stokes/CoVectorValued/Library')
        end
...
%             rmpath([disk ':\msem\MSEM_codes\Single_Grid_V5\Stokes\CoVectorValued\Library'])
            ...
            rmpath('C:\Users\Jasper\Documents\MATLAB\MSEM_codes\Single_Grid_V5\Stokes\CoVectorValued\Library')
        ...
        elseif isunix
            ...
            rmpath('/media/My Passport/MSEM/MSEM_codes/Single_Grid_V5/Stokes/CoVectorValued/Library')
        end
