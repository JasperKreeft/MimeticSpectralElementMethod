...
Domain       = 'SinDeformGrid_x';%'SinDeformGrid';
DomInfo      = 0.2;
...
% Reconstruction
phi          = reconstruct_adaptive(2,PHI,ep,Meshp);
[qx,qy,qMag] = reconstruct_adaptive(1,Qxi,Qeta,hp,ep,Meshp);

% Interpolated solution
% PHI_exact    = potentialValue(xi,eta,FunctionType,Domain,DomInfo); % Does not exist
% phi_interp   = reconstruct_adaptive(2,PHI_exact,ep,Meshp);
[Qxi_interp,Qeta_interp] = fluxValue(FunctionType,Domain,DomInfo);
[qx_interp,qy_interp,q_interp] = reconstruct_adaptive(1,Qxi_interp,Qeta_interp,hp,ep,Meshp);
