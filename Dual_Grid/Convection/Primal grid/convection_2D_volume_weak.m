...
IT = [ a*kron(speye(N),e') ; b*IT2 ];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[xiG,wG]   = Gnodes(N);
[h_w,dhdxiw] = LagrangeVal(xiG,N,1);
e_w          = EdgeVal(dhdxiw);

Wgg  = spdiags(kron(wG,wG)',0,N^2,N^2);
Iglg_xi  = kron(e_w,speye(N));
Iglg_eta = kron(speye(N),e_w);
Iglg = full(Iglg_xi*Iglg_eta);
